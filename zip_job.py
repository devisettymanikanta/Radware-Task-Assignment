...
# Create an array of a, b, c, d, e, f....z
...
# Make sure all txt files are created and if not - fail the script
...
# Create zip files with names based on array + VERSION environment variable, that each one will have one txt file inside
...
# Make sure all zip files are created and if not - fail the script
...
if __name__ == "__main__":
    ...
    # Make sure all txt files are created
    verify_txt_files()

    # Create zip files with names based on array + VERSION environment variable
    create_zip_files(version)

    # make sure all zip files are created
